...
$sql = "SELECT F_Name, L_Name, DocPhone FROM DOCTOR WHERE Dr_Specialty='$Specialty'";
...
{
  print "I found " . mysqli_affected_rows($link) . " Doctor(s)!<br>";
  print "_________________________________________________________<br>";
  while($row = mysqli_fetch_assoc($result))
  {
    // print "_________________________________________________________<br>";
    print "First Name:  ". $row['F_Name'] . "<br>";
    print "Last Name:  ". $row['L_Name'] . "<br>";
    print "Phone:  ". $row['DocPhone'] . "<br>";
    print "_________________________________________________________<br>";
  }
}
else
