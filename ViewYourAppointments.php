...
$sql = "SELECT * FROM VISIT WHERE PatientPhone='$Phone_Number' AND F_Name='$F_Name'";
...
{
  print "I found " . mysqli_affected_rows($link) . " appointment(s)!<br>";
  print "_________________________________________________________<br>";
  while($row = mysqli_fetch_assoc($result))
  {
    // print "_________________________________________________________<br>";
    print "VisitId:  ". $row['VisitID'] . "<br>";
    print "DoctorId:  ". $row['DoctorID'] . "<br>";
    print "SSN:  ". $row['SSN'] . "<br>";
    print "F_Name:  ". $row['F_Name'] . "<br>";
    print "L_Name:  ". $row['L_Name'] . "<br>";
    print "PatientPhone:  ". $row['PatientPhone'] . "<br>";
